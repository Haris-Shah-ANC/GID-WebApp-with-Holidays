    ...
    <>
      <label className="inline-flex items-center cursor-pointer">
        <input
          {...rest}
          type="checkbox"
          className="form-checkbox appearance-none ml-1 w-5 h-5 ease-linear transition-all duration-150 border border-blueGray-300 rounded focus:border-blueGray-300"
        />
        {label ? (
