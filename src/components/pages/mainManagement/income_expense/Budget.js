                ...
                <table className=" bg-transparent border-collapse table-auto w-full rounded-lg">
                    <thead className='bg-gray-200 px-10 justify-center items-center'>
                        <tr className='justify-between h-10'>
                            ...
                            <th
                                key={"valid_from"}
                                className={`text-sm p-3 text-left text-blueGray-500 font-interVar font-bold w-1/6 font-quicksand font-bold`}>
                                Valid From
                            </th>
                            <th
                                key={"valid_upto"}
                            ...
                            <th
                                key={"action"}
                                className={`text-sm px-3  text-blueGray-500 font-interVar font-bold w-1/5 font-quicksand font-bold`}>
                                Action
                            </th>
                        </tr>
                    </thead>
